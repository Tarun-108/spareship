    ...
    <div>
        ...
        <CardBody>
          <div className="flex justify-between">
            <Typography variant="h5" color="blue-gray" className="mb-2">
              {cardData.complainerName},&nbsp;
              <span className="font-light">{`Complaint#${cardData._id}`}</span>
            </Typography>
      ...
      <Dialog open={open} handler={handleOpen}>
        ...
        <DialogBody divider>
          ...
          <Typography>Product: {cardData.productName}</Typography>
